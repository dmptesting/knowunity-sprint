    ...
    docs: {
      description: {
        component: [
          ...
          '- **Tertiary Pressed looks like Tertiary Default.** Figma\'s treatment is a 10%-white overlay on a label that is already `text/primary`, near-white, which is imperceptible. Not substituted with a stronger effect.',
          '- **Secondary Loading uses `text/primary` for the spinner.** Figma binds that hidden label to `interactive/onPrimary` (near-black), near-invisible on `background/surface` — read as leftover from duplicating the Primary variant.',
