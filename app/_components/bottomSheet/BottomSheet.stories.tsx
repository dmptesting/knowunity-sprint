    ...
    docs: {
      description: {
        component: [
          ...
          '### Also worth knowing',
          '',
          "- **It carries the recall verdict, overriding Figma's DON'T.** The Figma description says not to use it for the voice-recall verdict, because recall is judged three ways. The sheet was chosen as the verdict design anyway (2026-09-15), and the full-page Result screen was removed. Two results cover three verdicts: partial and fail share `incorrect` and are told apart by the title (\"So close…\" / \"Not quite\"), which keeps sprint-context.md's three-way judgment in the copy.",
