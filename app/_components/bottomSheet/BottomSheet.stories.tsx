    ...
    docs: {
      description: {
        component: [
          ...
          '',
          "**DON'T:** use it for the voice-recall verdict — recall is judged pass/partial/fail, and SPEC.md forbids an error treatment behind a miss.",
          '',
          '### Also worth knowing',
          '',
          '- **It conflicts with the recall loop on purpose.** sprint-context.md rules out collapsing judgment to correct/incorrect, and SPEC.md paints no error panel behind a miss. The recall screens use `verdictHeader` on the neutral surface; this sheet is for quiz-style feedback only.',
