    ...
    docs: {
      description: {
        component: [
          ...
          '### Knowie remembers',
          '',
          'Below the stats, Knowie (`mascotSlot` 3XL, centred) sits above a tailless `calloutBubble` (`showTail={false}`) recalling one passed answer in the student\'s own terms, to show he was really listening. The session picks it with `pickRecallLine`: of the passed questions, the one that took the fewest hints, and on a tie the earliest. Each question carries its own `recall` line in script.ts, written against its passing transcript.',
          '',
