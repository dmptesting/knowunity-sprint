    ...
    docs: {
      description: {
        component: [
          ...
          '- **Each tile has its own accent and icon** (`statTile`\'s `stat`: blue XP, green score, brand time). 09 hand-draws them; the build-screen skill lists that as a known wrong.',
          ...
          "- **Labels are sentence case.** The `statTile` component set sets them uppercase: `XP` / `SCORE` / `BLAZING`. `XP` stays as it is, being an abbreviation; the other two become \"Score\" and \"Time\" — \"Blazing\" would praise a slow run as readily as a fast one.",
        ].join('\n'),
      },
    },
  },
